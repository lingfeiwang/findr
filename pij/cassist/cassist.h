...
#ifndef _HEADER_LIB_PIJ_CASSIST_H_
#define _HEADER_LIB_PIJ_CASSIST_H_
 ...
 * g:	(ng,ns) Genotype data for E, =0,1,...,nv-1. Each is the best eQTL of the corresponding gene in t.
